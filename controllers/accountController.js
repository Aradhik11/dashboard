...
class AccountController {
  ...
  async createAccount(req, res, next) {
    ...
    try {
      ...
      const result = await pool.query(
        ...
        (email, first_name, last_name, phone, address, created_at, updated_at) 
  ...
  async updateAccount(req, res, next) {
    ...
    try {
      ...
      const result = await pool.query(
        `UPDATE accounts 
        SET email = $1, first_name = $2, last_name = $3, phone = $4, address = $5, updated_at = NOW() 
        WHERE id = $6 
        RETURNING id, email, first_name, last_name, phone, address, updated_at`,
        [email, firstName, lastName, phone, address, id]
      );
